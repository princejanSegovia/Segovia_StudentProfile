document.addEventListener("DOMContentLoaded", function () {
    ...
    if (editProfileButton) {
        ...
        if (savedProfile) {
            ...
            profileDegree.textContent = profileData.degree;
        ...
        editProfileButton.addEventListener("click", function () {
            ...
            degreeInput.value = profileDegree.innerText;
    ...
    if (saveProfileButton) {
        ...
        saveProfileButton.addEventListener("click", function () {
            ...
            const updatedDegree = degreeInput.value.trim();
            ...
            profileDegree.textContent = updatedDegree;
    ...
    const editSkillsButton = document.getElementById("edit-skills-btn");
    const editSkillsPanel = document.getElementById("edit-skills-panel");
    ...
    const skill1Input = document.getElementById("edit-skill-1");
    const skill2Input = document.getElementById("edit-skill-2");
    const skill3Input = document.getElementById("edit-skill-3");
    const skill4Input = document.getElementById("edit-skill-4");
    const skill5Input = document.getElementById("edit-skill-5");

    const saveSkillsButton = document.getElementById("save-skills");
    const cancelSkillsButton = document.getElementById("cancel-skills");
    ...
    if (editSkillsButton) {
        ...
        if (savedSkills) {
            ...
            skill1.textContent = skillsData.skill1;
            skill2.textContent = skillsData.skill2;
            skill3.textContent = skillsData.skill3;
            skill4.textContent = skillsData.skill4;
            skill5.textContent = skillsData.skill5;
        ...
        editSkillsButton.addEventListener("click", function () {
            ...
            skill1Input.value = skill1.innerText;
            skill2Input.value = skill2.innerText;
            skill3Input.value = skill3.innerText;
            skill4Input.value = skill4.innerText;
            skill5Input.value = skill5.innerText;
    ...
    if (saveSkillsButton) {
        ...
        saveSkillsButton.addEventListener("click", function () {
            ...
            const updatedSkill1 = skill1Input.value.trim();
            const updatedSkill2 = skill2Input.value.trim();
            const updatedSkill3 = skill3Input.value.trim();
            const updatedSkill4 = skill4Input.value.trim();
            const updatedSkill5 = skill5Input.value.trim();
            ...
            skill1.textContent = updatedSkill1;
            skill2.textContent = updatedSkill2;
            skill3.textContent = updatedSkill3;
            skill4.textContent = updatedSkill4;
            skill5.textContent = updatedSkill5;
    ...
    if (cancelSkillsButton) {
        ...
        cancelSkillsButton.addEventListener("click", function () {
    ...
    const editContactButton = document.getElementById("edit-contact-btn");
    ...
    if (editContactButton) {
        ...
        if (savedContact) {
            ...
            contactFacebook.textContent = contactData.facebook;
            contactGithub.textContent = contactData.github;
            contactNumber.textContent = contactData.number;
        ...
        editContactButton.addEventListener("click", function () {
            ...
            emailInput.value = contactEmail.innerText;
            facebookInput.value = contactFacebook.innerText;
            githubInput.value = contactGithub.innerText;
            numberInput.value = contactNumber.innerText;
    ...
    if (saveContactButton) {
        ...
        saveContactButton.addEventListener("click", function () {
            ...
            const updatedFacebook = facebookInput.value.trim();
            const updatedGithub = githubInput.value.trim();
            const updatedNumber = numberInput.value.trim();
            ...
            contactEmail.textContent = updatedEmail;
            contactFacebook.textContent = updatedFacebook;
            contactGithub.textContent = updatedGithub;
            contactNumber.textContent = updatedNumber;
    ...
    const editProjectsButton = document.getElementById("edit-projects-btn");
    const editProjectsPanel = document.getElementById("edit-projects-panel");

    const project1 = document.getElementById("project-1");
    const project2 = document.getElementById("project-2");
    const project3 = document.getElementById("project-3");

    const projectDescription1 = document.getElementById("project-description-1");
    const projectDescription2 = document.getElementById("project-description-2");
    const projectDescription3 = document.getElementById("project-description-3");

    const project1Input = document.getElementById("edit-project-1");
    const project2Input = document.getElementById("edit-project-2");
    const project3Input = document.getElementById("edit-project-3");
    ...
    const saveProjectsButton = document.getElementById("save-projects");
    const cancelProjectsButton = document.getElementById("cancel-projects");
    ...
    if (editProjectsButton) {
        ...
        if (savedProjects) {
            ...
            project1.textContent = projectsData.project1;
            project2.textContent = projectsData.project2;
            project3.textContent = projectsData.project3;
        ...
        editProjectsButton.addEventListener("click", function () {
            ...
            project1Input.value = project1.innerText;
            project2Input.value = project2.innerText;
            project3Input.value = project3.innerText;
    ...
    if (saveProjectsButton) {
        ...
        saveProjectsButton.addEventListener("click", function () {

            const updatedProject1 = project1Input.value.trim();
            const updatedProject2 = project2Input.value.trim();
            const updatedProject3 = project3Input.value.trim();
            ...
            project1.textContent = updatedProject1;
            project2.textContent = updatedProject2;
            project3.textContent = updatedProject3;
    ...
    if (cancelProjectsButton) {
        ...
        cancelProjectsButton.addEventListener("click", function () {
    ...
    const editAboutPanel = document.getElementById("edit-about-panel");
    ...
    if (saveAboutButton) {
        ...
        saveAboutButton.addEventListener("click", function () {
            ...
            const updatedAbout = aboutInput.value.trim();
            ...
            aboutText.textContent = updatedAbout;
